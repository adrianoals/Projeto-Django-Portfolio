...
def projeto(request):
        projetos_web_api = ProjetoWebAPI.objects.order_by('-data_criacao')
        projetos_automacoes = ProjetoAutomacao.objects.order_by('-data_criacao')
        projetos_mobile = ProjetoMobile.objects.order_by('-data_criacao')
